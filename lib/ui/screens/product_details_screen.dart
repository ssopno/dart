...
import 'package:ecommerceprojct/ui/widget/product_details/product_image_carousel.dart';
import 'package:ecommerceprojct/ui/widget/product_stepper.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ProductController>(
        ...
        colors = getColor(productDetails.color ?? '');
                          ...
                          return CommonElevatedButton(
                              ...
                              if(result){
                                ...
                                Get.find<CartController>().addToCart(
                                    productDetails.product!.id!, _selectedSize!,
